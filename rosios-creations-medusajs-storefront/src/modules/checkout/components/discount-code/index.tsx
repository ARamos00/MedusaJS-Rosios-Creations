...
const DiscountCode: React.FC<DiscountCodeProps> = ({ cart }) => {
  ...
  return (
      <div className="w-full bg-blush-light text-grey-darkest font-sans p-4 rounded-md shadow-md flex flex-col">
              ...
              <form action={formAction} className="w-full">
                <Label className="flex gap-x-1 my-2 items-center">
                  <button
                      ...
                      type="button"
                      className="txt-medium text-blush-dark hover:text-blush transition-colors duration-200 ease-in-out"
